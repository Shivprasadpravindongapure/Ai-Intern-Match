...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-64px)] items-center justify-center px-4 py-12 bg-grid-pattern">
      ...
      {/* Card */}
      <div className="relative z-10 w-full max-w-md glass-strong rounded-2xl p-8 sm:p-10 glow-blue">
        {/* Header */}
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold gradient-text mb-2">Welcome Back</h1>
          <p className="text-slate-400 text-sm">Sign in to SkillProof AI</p>
        </div>
